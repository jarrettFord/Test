...
/*   9:    */ 
/*  10:    */ public class SocksCmdRequestDecoder
/*  11:    */   extends ReplayingDecoder<State>
/*  12:    */ {
/*  13:    */   private static final String name = "SOCKS_CMD_REQUEST_DECODER";
/*  14:    */   private SocksProtocolVersion version;
/*  15:    */   private int fieldLength;
/*  16:    */   private SocksCmdType cmdType;
...
/*  24:    */   {
/*  25: 37 */     return "SOCKS_CMD_REQUEST_DECODER";
/*  26:    */   }
/*  27:    */   
/*  28: 47 */   private SocksRequest msg = SocksCommonUtils.UNKNOWN_SOCKS_REQUEST;
/*  29:    */   
/*  30:    */   public SocksCmdRequestDecoder()
/*  31:    */   {
...
/*  36:    */     throws Exception
/*  37:    */   {
/*  38: 55 */     switch (1.$SwitchMap$io$netty$handler$codec$socks$SocksCmdRequestDecoder$State[((State)state()).ordinal()])
/*  39:    */     {
/*  40:    */     case 1: 
...
/*  45:    */       break;
/*  46:    */     case 2: 
/*  47: 64 */       this.cmdType = SocksCmdType.valueOf(byteBuf.readByte());
...
/*  57: 74 */         this.msg = new SocksCmdRequest(this.cmdType, this.addressType, this.host, this.port);
/*  58: 75 */         break;
/*  59:    */       case 2: 
...
/*  63: 81 */         this.msg = new SocksCmdRequest(this.cmdType, this.addressType, this.host, this.port);
/*  64: 82 */         break;
/*  65:    */       case 3: 
/*  66: 85 */         this.host = SocksCommonUtils.ipv6toStr(byteBuf.readBytes(16).array());
/*  67: 86 */         this.port = byteBuf.readUnsignedShort();
/*  68: 87 */         this.msg = new SocksCmdRequest(this.cmdType, this.addressType, this.host, this.port);
/*  69:    */       }
/*  70: 88 */       break;
/*  71:    */     }
 ...
 * Qualified Name:     io.netty.handler.codec.socks.SocksCmdRequestDecoder
