...
/*  14:    */ 
/*  15:    */ public class WebSocketClientHandshaker08
/*  16:    */   extends WebSocketClientHandshaker
/*  17:    */ {
/*  18: 42 */   private static final InternalLogger logger = InternalLoggerFactory.getInstance(WebSocketClientHandshaker08.class);
...
/*  22:    */   
/*  23:    */   public WebSocketClientHandshaker08(URI webSocketURL, WebSocketVersion version, String subprotocol, boolean allowExtensions, HttpHeaders customHeaders, int maxFramePayloadLength)
/*  24:    */   {
...
/*  46:113 */       logger.debug("WebSocket version 08 client handshake key: {}, expected response: {}", key, this.expectedChallengeResponseString);
/*  47:    */     }
...
/*  66:    */     }
/*  67:141 */     headers.add("Sec-WebSocket-Version", "8");
...
/*  96:    */   {
/*  97:194 */     return new WebSocket08FrameDecoder(false, this.allowExtensions, maxFramePayloadLength());
/*  98:    */   }
/*  99:    */   
/* 100:    */   protected WebSocketFrameEncoder newWebSocketEncoder()
/* 101:    */   {
/* 102:199 */     return new WebSocket08FrameEncoder(true);
/* 103:    */   }
/* 104:    */ }


/* Location:           C:\Users\User\Desktop\spam.jar
 * Qualified Name:     io.netty.handler.codec.http.websocketx.WebSocketClientHandshaker08
